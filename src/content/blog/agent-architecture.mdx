...
<Callout type="tip" title="The Identity Principle">
Same model, same API, completely different behavior. The system prompt defines agent identity. Custom agents are built for your codebase—default agents are built for everyone's.
</Callout>
