...
Implement a task directly without creating a plan first. Use for simple, well-defined tasks.
...
1. **Prime with Context**: First, read and execute `/prime` to understand the codebase
...
Use the task description from the `task_description` variable: $2
...
4. **Validate**: Run validation commands to confirm success
