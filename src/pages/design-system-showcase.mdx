...
description: "Internal showcase of ACIDBATH design system components for testing."
---
...
Six semantic variants highlight different content types.
...
<Callout type="note" title="Design Note">
...
**Usage**: General notes, key information, design decisions
...
**Usage**: Tips, best practices, actionable insights
...
- **Note**: Blue for general information and design notes
- **Tip**: Purple for helpful tips and best practices
- **Info**: Blue for informational content
- **Warning**: Amber for gotchas and performance considerations
- **Danger**: Red for errors and critical warnings
- **Quote**: Slate for quotes and testimonials
...
<Callout type="info" title="Bundle Size Analysis">

- **Design System CSS**: 8KB gzipped
- **Total Bundle Increase**: 4.2% (target: under 10%)
...
<Callout type="tip">
This is a helpful tip that will appear prominently.
</Callout>
```
