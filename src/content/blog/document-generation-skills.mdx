...
<Callout type="tip" title="The Unsexy ROI">
100 minutes manual → 10 minutes automated. That's 90 minutes per report. Do this quarterly and you've saved 6 hours/year per analyst. With 10 analysts, that's 60 hours/year on one workflow.
</Callout>
...
<Callout type="warning" title="Complexity Limits">
Keep it simple: 2-3 Excel sheets, 5-7 PowerPoint slides, 10-15 PDF pages. Beyond these limits, reliability degrades and generation time explodes.
</Callout>
