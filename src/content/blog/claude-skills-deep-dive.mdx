...
<Callout type="tip" title="The Token Math">
...
<Callout type="info" title="Skills vs MCP Decision">
**Use Skills for**: Document generation, deterministic workflows, template-based tasks, offline operations.
**Use MCP for**: External APIs, real-time data, bidirectional communication, complex state.
</Callout>
...
<Callout type="danger" title="Version Pinning Required">
